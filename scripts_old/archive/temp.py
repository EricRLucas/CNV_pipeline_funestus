...
accessibility_mask_file = '/nfs/users/nfs_e/el10/personal/phase3_data/windowed_accessibility/mean_accessibility_gambcolu.csv'
mapq0_threshold = 0.5
mapq0_file = '/nfs/users/nfs_e/el10/personal/phase3_data/mapq_proportions/mapq_proportions_allchrom_gambcolu.csv'
sample_manifest = '/nfs/users/nfs_e/el10/personal/v3.6_1288-VO-UG-DONNELLY-VMF00168/data/sample_manifest_gambcolu.txt'
gc_content_filename = '/nfs/users/nfs_e/el10/personal/phase3_data/tables/Agam_genome_GC_content.csv'
working_folder = '/nfs/users/nfs_e/el10/personal/v3.6_1288-VO-UG-DONNELLY-VMF00168/coverage'
output_file_key = 'gambcolu'
