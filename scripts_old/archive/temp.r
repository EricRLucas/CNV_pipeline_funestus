...
arg.values <- c('/lustre/scratch118/malaria/team112/personal/el10/v3.3_1190-VO-GH-AMENGA-ETEGO-VMF00028/data/sample_manifest_arabiensis.txt',
'/nfs/users/nfs_e/el10/personal/phase3_data/tables/gene_regions.csv',
'/nfs/users/nfs_e/el10/personal/v3.3_1190-VO-GH-AMENGA-ETEGO-VMF00028/data/sample_metadata_tabs.tsv',
'arabiensis',
'/lustre/scratch118/malaria/team112/personal/el10/v3.3_1190-VO-GH-AMENGA-ETEGO-VMF00028/coverage/coverage_variance_masked_09_05_all.csv',
'/lustre/scratch118/malaria/team112/personal/el10/v3.3_1190-VO-GH-AMENGA-ETEGO-VMF00028/coverage',
'/lustre/scratch118/malaria/team112/personal/el10/v3.3_1190-VO-GH-AMENGA-ETEGO-VMF00028/modal_CNVs')
...
modal.copy.numbe1 <- cbind(meta[rownames(modal.copy.number), 'sex_call', drop = F], 
