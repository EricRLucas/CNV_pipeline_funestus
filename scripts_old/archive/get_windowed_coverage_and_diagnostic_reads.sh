...
python $SSFA_script $bamfile 2RL 85450000:85500000 ${SSFAfolder}/2RL/Zinccarbo_region/${samplename}_Zinccarbo_SSFA_output.csv 10 > ${SSFAfolder}/2RL/Zinc_carbo_region/SSFAlogs/${samplename}_Zinc_carbo_SSFA_output.log 2>&1
