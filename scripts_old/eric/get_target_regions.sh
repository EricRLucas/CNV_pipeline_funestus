...
scriptsfolder=/nfs/users/nfs_j/jn11/my_lustre/cnv_calls/CNV_funestus/scripts/eric
plotting_functions_file=$scriptsfolder/../plotting_functions.r

cd $workingfolder

mkdir -p target_regions_analysis_eric
...
R-3.6.1 --slave -f $scriptsfolder/get_target_regions.r --args $manifest \
                                                              ...
                                                              $ncores \
                                                              > target_regions_analysis_eric/get_target_regions.log 2>&1
