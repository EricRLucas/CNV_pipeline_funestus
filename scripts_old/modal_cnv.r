...
modal.copy.number <- data.frame(do.call(cbind, lapply(chroms, modal.copy.number.change)))
...
output.fn = paste(output.folder, '/modal_copy_number.csv', sep = '')
